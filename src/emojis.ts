/**
 * Custom emoji registry: name → [emoji ID, animated flag].
 */
export const ALL_EMOJIS: Record<string, [string, boolean]> = {
	...
	renxCAUGHT: ["1381957367851384933", false],
	renxBRAINROT: ["1381957362100731934", false],
	...
	yaelicking: ["1477854339115651092", true],
	...
	renxLOOKDOWN: ["1381957356807651410", false],
...
/**
 * Look up an available custom emoji by name.
 *
 * @returns		ID and animated status, or null when unknown.
 */
export function emojis(name: string): [string, boolean] | null {
